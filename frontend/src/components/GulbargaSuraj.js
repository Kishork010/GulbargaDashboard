...
function SurajSarda() {
  ...
  const fetchData = async () => {
    try {
      ...
      const tlData = json.filter(row => row['tl_name']?.trim() === 'PSS1_300B640');
      setTlData(tlData); // Set the filtered data to tlData state
  ...
  return (
    <div className="gulbarga-container">
      <h2>SURAJ SARDA(PSS1_300B640) Gulbarga</h2>
